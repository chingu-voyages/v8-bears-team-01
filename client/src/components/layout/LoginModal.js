    ...
    <div className="container">
      ...
      >
        ...
        <div className="content">
          ...
          <p>or</p>
          <input type="email" className="form-control" onChange={(e)=>props.updateEmail(e.target.value)} placeholder="Email" />
          <br />
          <input type="password" className="form-control" onChange={(e)=>props.updatePassword(e.target.value)} placeholder="Password" />
          <br />
          <button onClick={props.handleLogin} className="btn sign-up-button mb-4">Log in</button>
        </div>
      </ReactModal>
    </div>
